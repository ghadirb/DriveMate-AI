...
صوت تا ۸MB (ضبط خودکار حداکثر ۳۰ ثانیه)، تصویر تا ۱۰MB و ویدیو تا ۲۵MB پذیرفته می‌شود. پاسخ همیشه باید احتمالی تلقی شود و جایگزین مکانیک یا دادهٔ OBD-II نیست.
